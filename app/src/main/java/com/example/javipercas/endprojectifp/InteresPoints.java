...
public class InteresPoints extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interes_points);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng stq = new LatLng(41.470918, 2.083967);
        mMap.addMarker(new MarkerOptions().position(stq).title("Sant Cugat del Vallés").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
        float zoomLevel = 16;

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(stq, zoomLevel));
    }
